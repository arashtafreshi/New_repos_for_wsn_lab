...
* @author tafreshi
*/
public class Task5 extends javax.swing.JFrame implements MessageListener {
	...
	/*public Task5(MoteIF moteIF) {
	this.moteIF = moteIF;
	this.moteIF.registerListener(new Task5Msg(), this);
}*/

	
	public void sendTempCommand(int DestID){
		Task5Msg payload = new Task5Msg();
	...
	public void messageReceived(int to, Message message) {
		//  Task5Msg msg = (Task5Msg)message;
		// System.out.println("Received packet sequence number " + msg.get_Counter());
		//if (message instanceof NodeToNodeMsg_t) {
		System.out.println("Java app received Packet");
		Task5Msg tempmsg = (Task5Msg)message;
	...
	private static void usage() {
		System.err.println("usage: Task5 [-comm <source>]");
	}
	//******************************************************************
	...
	*/
	...
	private void initComponents() {
		...
		moteIF.registerListener(new Task5Msg(), this);

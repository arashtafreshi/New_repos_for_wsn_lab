...
* @author tafreshi
*/
public class Task4 extends javax.swing.JFrame implements MessageListener {

	/** Creates new form Task4 */
	public Task4() {
		initComponents();
	}
	...
	/*public Task4(MoteIF moteIF) {
	this.moteIF = moteIF;
	this.moteIF.registerListener(new Task4Msg(), this);
}*/

	
	public void sendTempCommand(int DestID){
		Task4Msg payload = new Task4Msg();
	...
	private static void usage() {
		System.err.println("usage: Task4 [-comm <source>]");
	}
	//******************************************************************
	...
	*/
	...
	private void initComponents() {
		...
		moteIF.registerListener(new Task4Msg(), this);

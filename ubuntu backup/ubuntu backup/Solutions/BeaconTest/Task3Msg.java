 ...
 * This class implements a Java interface to the 'Task3Msg'
 * message type.
 */

public class Task3Msg extends net.tinyos.message.Message {
    ...
    /** Create a new Task3Msg of size 8. */
    public Task3Msg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Task3Msg of the given data_length. */
    public Task3Msg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Task3Msg with the given data_length
     * and base offset.
     */
    public Task3Msg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Task3Msg using the given byte array
     * as backing store.
     */
    public Task3Msg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public Task3Msg(byte[] data, int base_offset) {
     ...
     */
    public Task3Msg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Task3Msg embedded in the given message
     * at the given base offset.
     */
    public Task3Msg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public Task3Msg(net.tinyos.message.Message msg, int base_offset, int data_length) {
